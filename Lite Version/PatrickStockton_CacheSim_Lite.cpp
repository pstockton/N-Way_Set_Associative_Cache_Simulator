...
void readConfigFile( ) {
    ...
    cout << "=================================================================" << endl;
    cout << "Please enter the name of your desired input configuration file." << endl;
...
void readTraceFile( ) {
    ...
    cout << "=================================================================" << endl;
    cout << "Please enter the name of your desired input trace file." << endl;
    cout << "If the input file is in the same folder, input the file name" << endl;
    cout << "If the input file is in a different directory, enter the directory/file address" << endl;
    ...
    cout << "\nNumber of accesses: " << num_of_accesses - 1 << endl;
    cout << "Number of hits: " << hit_count - 1 << endl;
